...
- [x] investigate issue where cluster's storage profile is being updated every few minutes.
...
- [x] The AKS cluster is created with default CNI
...
- [x] Research other pre and post cluster create needs from customer and provide guidance
- [x] Research alternatives to Codespaces for setting up bootstrap environment

### AzureManagedMachinePool name conflict

- [x] Issue when creating multiple AKS clusters using default AKS template.
