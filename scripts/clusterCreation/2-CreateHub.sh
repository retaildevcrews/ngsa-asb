...
function collectInputParameters()
{
  ...
  if [ -z $1 ]; then
    ...
    echo "This command can be retrieved by running ./scripts/clusterCreation/1-CheckPrerequisites.sh from your local machine (not CodeSpaces)" 1>&2
    exit 1
  else 
...
{
  azure_locations=( "australiaeast" "centralus" "eastus" "eastus2" "japaneast" "northeurope" "southcentralus" "southeastasia" "uksouth" "westeurope" "westus2" "westus3" "northcentralus" )
